...
class ContactHelper:
    ...
    def get_contact_list(self):
        if self.contact_cache is None:
            ...
            for row in wd.find_elements_by_name("entry"):
                ...
                self.contact_cache.append(Contact(address = all_addresses, lastname=lastname,firstname=firstname,id=id,all_phones_from_home_page = all_phones, all_email_from_home_page= all_email ))
    ...
    def get_contact_info_from_edit_page(self,index):
        ...
        return Contact(firstname=firstname, lastname=lastname, id = id, homephone = homephone,
                       mobilephone = mobilephone, workphone = workphone, email= email, email2= email2, email3= email3, address = address,
                       )
